...
Only CentOS image is published publicly with upstream GlusterFS 3.5 available
at `index.docker.io`, use below command to download published image.

    # docker pull y4m4/centos6
